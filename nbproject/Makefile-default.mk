...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/twitter.p1 ${OBJECTDIR}/wireMasterInterface.p1 ${OBJECTDIR}/async.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/interval.p1 ${OBJECTDIR}/json.p1 ${OBJECTDIR}/jspic.p1 ${OBJECTDIR}/jwire.p1 ${OBJECTDIR}/macaw.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/string2.p1 ${OBJECTDIR}/superSimpleSerial.p1 ${OBJECTDIR}/wireMaster.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/twitter.p1.d ${OBJECTDIR}/wireMasterInterface.p1.d ${OBJECTDIR}/async.p1.d ${OBJECTDIR}/interrupts.p1.d ${OBJECTDIR}/interval.p1.d ${OBJECTDIR}/json.p1.d ${OBJECTDIR}/jspic.p1.d ${OBJECTDIR}/jwire.p1.d ${OBJECTDIR}/macaw.p1.d ${OBJECTDIR}/serial.p1.d ${OBJECTDIR}/string2.p1.d ${OBJECTDIR}/superSimpleSerial.p1.d ${OBJECTDIR}/wireMaster.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/twitter.p1 ${OBJECTDIR}/wireMasterInterface.p1 ${OBJECTDIR}/async.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/interval.p1 ${OBJECTDIR}/json.p1 ${OBJECTDIR}/jspic.p1 ${OBJECTDIR}/jwire.p1 ${OBJECTDIR}/macaw.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/string2.p1 ${OBJECTDIR}/superSimpleSerial.p1 ${OBJECTDIR}/wireMaster.p1 ${OBJECTDIR}/main.p1
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/JSPIC.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/wireMasterInterface.p1: wireMasterInterface.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/wireMasterInterface.p1.d 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G --asmlist  -D__DEBUG=1 --debugger=pickit2  --double=24 --float=24 --emi=wordwrite --opt=all,-asm,-asmfile,+speed,-space,+debug,9 --addrqual=ignore --mode=pro -P -N255 -V --warn=4 --summary=default,-psect,-class,+mem,-hex,-file --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+config,+clib,+plib "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"  -o${OBJECTDIR}/wireMasterInterface.p1  wireMasterInterface.c 
	@-${MV} ${OBJECTDIR}/wireMasterInterface.d ${OBJECTDIR}/wireMasterInterface.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/wireMasterInterface.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/JSPIC.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G --asmlist -mdist/${CND_CONF}/${IMAGE_TYPE}/JSPIC.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=all,-asm,-asmfile,+speed,-space,+debug,9 --addrqual=ignore --mode=pro -P -N255 -V --warn=4 --summary=default,-psect,-class,+mem,-hex,-file --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+config,+clib,+plib "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"   -odist/${CND_CONF}/${IMAGE_TYPE}/JSPIC.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
